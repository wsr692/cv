...
module.exports = {
  ...
  siteMetadata: {
    ...
    about: `
      ...
      직접 훈련에 사용할 음성 인식용 데이터를 효율적으로 구축하기 위해, 데이터를 검수/관리하는 웹서비스를 기획하고 운영한 이력이 있습니다. 불편한 것을 개선하는 일을 좋아하고, 특히나 조직 내에서 효율적인 업무 파이프라인을 구축하는 일에 관심이 많습니다. </p>
      <a href="https://www.w3schools.com/">데이터 검수/관리 서비스 NAMZSTER API 문서</a><br>
      <a href="https://www.w3schools.com/">영어 문법 및 어휘 평가 시스템 API 문서</a><br>
      `,
