    ...
    experience: [
      {
        ...
        <li style="line-height: 20px;text-indent: 50px;">Led development of multi-lingual (English, Korean, Japanese and Mandarin Chinese) voice command based system for
