...
module.exports = {
  ...
  siteMetadata: {
    ...
    about: `
      <p> 음성 인식과 합성 분야에서 연구와 개발을 해 왔습니다. 다국어 음성 인식 시스템 개발을 리드한 경험을 가지고 있으며 2022년에 음성합성으로 박사학위를 취득했습니다. <br><br>현재는 어학 에듀테크 (EdTech) 분야에서 영어 문법, 어휘, 발음 평가 솔루션을 기획하고 개발하고 있습니다. <br><br> 
